...
/*   Updated: 2022/11/16 16:02:04 by rpoder           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	c1 = create_cylinder(NULL, create_tuple(0, 0, 0, 1), 1);
	ray = ft_create_ray(create_tuple(0, 1.5, -2, 1), create_tuple(0, 0, 1, 0));
	ray.direction = ft_normalize_tuple(ray.direction);
	ft_print_intersection(get_cylinder_intersections(c1, ray));
	// ft_print_tuple("normal_at", cylinder_normal_at(c1, create_tuple(-1, 1, 0, 1)));
