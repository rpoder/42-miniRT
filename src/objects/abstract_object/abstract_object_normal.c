...
/*   Updated: 2022/12/01 00:13:37 by rpoder           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_tuple	get_object_normal_at(t_object *object, t_tuple world_point)
{
	...
	if (object->object_type == SPHERE_TYPE)
		...
		object_normal = get_triangle_normal_at(object);
